...
from services.s4_status import build_s4_status_data_with_dependencies as _build_s4_status
...
def _build_s4_status_data() -> dict:
    return _build_s4_status(
        deps={
            "get_db_cursor": get_db_cursor,
            "_normalize_s4_runtime_aliases": _normalize_s4_runtime_aliases,
            "_s4_confirm_streak": _s4_confirm_streak,
            "_safe_float": _safe_float,
            "_load_s4_fifo_open_lots": _load_s4_fifo_open_lots,
            "_sum_lots_cost": _sum_lots_cost,
            "mismatch_severity": mismatch_severity,
            "next_unlock_from_gate_reason": next_unlock_from_gate_reason,
        }
    )
